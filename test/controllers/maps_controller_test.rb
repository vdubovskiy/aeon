...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { area: @map.area, name: @map.name, population: @map.population, stage: @map.stage, type: @map.type }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { area: @map.area, name: @map.name, population: @map.population, stage: @map.stage, type: @map.type }
    assert_redirected_to map_path(assigns(:map))
  end
